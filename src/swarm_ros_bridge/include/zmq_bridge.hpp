 ...
 * It will estiblish the connections for the specified ROS topics
 * It will reconnect each other autonomously.
 * It has a queue for sending data asynchronously. 
 * 
 * Note: This program relies on ZMQPP (cpp lib of ZeroMQ).
 * sudo apt install libzmqpp-dev
 * 
 * Core Idea: It would create the sending and receving thread for each ROS topic and processing asynchronously.
 *       
 * @version 0.1
 * @date 2022-12-29
 * 
 ...
 * 
 */
#ifndef __ZMQ_BRIDGE__
#define __ZMQ_BRIDGE__
#include "stdio.h"
#include "stdlib.h"
#include "time.h"
